...
var fabrick_broker_client_id = 'FabrickClient001'
...
var gemtek_broker_client_id = 'FabrickClient001'
var gemtek_username = "200000191"
var gemtek_password = "35269094"
...
client.on('connect', () => {
    ...
    client.subscribe({ 'client/200000191/200000191-GIOT-MAKER': 1 }, function(err, granted) {
        if (err) {
...
client.on('message', function(topic, message, packet) {
    ...
    switch (topic) {
        case 'client/200000191/200000191-GIOT-MAKER':
