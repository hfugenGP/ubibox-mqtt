        ...
        case "03":
            ...
            MongoClient.connect(url, function(err, db) {
                db.collection('DeviceMessageLogs').insertOne(deviceData, function(err, r) {
                    ...
                    db.collection('DeviceStage').findOneAndUpdate({ deviceId: deviceId }, { deviceId: deviceId, status: "Active", lastUpdated: receivedDateText }, { upsert: true });
                });
            });
            ...
            if (this.dataTypeMajor == "f0") {
                switch (this.dataTypeMinor) {
                    ...
                    case "02":
                        break;
                    case "03":
                        var verifyData = common.recorrectHexString(this.VerifyPackage.fileNameLength.toString(16), 2) + common.hex_from_chars(this.VerifyPackage.fileName);
